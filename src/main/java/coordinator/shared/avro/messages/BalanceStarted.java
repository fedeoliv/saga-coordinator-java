...
public class BalanceStarted extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<BalanceStarted> ENCODER =
      new BinaryMessageEncoder<BalanceStarted>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<BalanceStarted> DECODER =
      new BinaryMessageDecoder<BalanceStarted>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageDecoder instance used by this class.
   */
  public static BinaryMessageDecoder<BalanceStarted> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<BalanceStarted> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<BalanceStarted>(MODEL$, SCHEMA$, resolver);
  }

  /** Serializes this BalanceStarted to a ByteBuffer. */
  public java.nio.ByteBuffer toByteBuffer() throws java.io.IOException {
    return ENCODER.encode(this);
  }

  /** Deserializes a BalanceStarted from a ByteBuffer. */
  public static BalanceStarted fromByteBuffer(
   ...
   */
  public BalanceStarted(java.lang.CharSequence transactionId, java.lang.CharSequence correlationId, java.lang.CharSequence accountFromId, java.lang.CharSequence accountToId, java.lang.CharSequence amount) {
  ...
  /**
   * Creates a new BalanceStarted RecordBuilder by copying an existing Builder.
  ...
  /**
   * Creates a new BalanceStarted RecordBuilder by copying an existing BalanceStarted instance.
  ...
  /**
   * RecordBuilder for BalanceStarted instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<BalanceStarted>
    implements org.apache.avro.data.RecordBuilder<BalanceStarted> {
    ...
    public BalanceStarted build() {
      try {
        BalanceStarted record = new BalanceStarted();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<BalanceStarted>
    WRITER$ = (org.apache.avro.io.DatumWriter<BalanceStarted>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<BalanceStarted>
    READER$ = (org.apache.avro.io.DatumReader<BalanceStarted>)MODEL$.createDatumReader(SCHEMA$);
