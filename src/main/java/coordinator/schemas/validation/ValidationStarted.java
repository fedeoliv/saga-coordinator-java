...
public class ValidationStarted extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4608340087315726117L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ValidationStarted\",\"namespace\":\"coordinator.schemas.validation\",\"fields\":[{\"name\":\"transactionId\",\"type\":\"string\"},{\"name\":\"correlationId\",\"type\":\"string\"},{\"name\":\"accountFromId\",\"type\":\"string\"},{\"name\":\"accountToId\",\"type\":\"string\"},{\"name\":\"amount\",\"type\":\"string\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<ValidationStarted> ENCODER =
      new BinaryMessageEncoder<ValidationStarted>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<ValidationStarted> DECODER =
      new BinaryMessageDecoder<ValidationStarted>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageDecoder instance used by this class.
   */
  public static BinaryMessageDecoder<ValidationStarted> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<ValidationStarted> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<ValidationStarted>(MODEL$, SCHEMA$, resolver);
  }

  /** Serializes this ValidationStarted to a ByteBuffer. */
  public java.nio.ByteBuffer toByteBuffer() throws java.io.IOException {
    return ENCODER.encode(this);
  }

  /** Deserializes a ValidationStarted from a ByteBuffer. */
  public static ValidationStarted fromByteBuffer(
   ...
   */
  public ValidationStarted(java.lang.CharSequence transactionId, java.lang.CharSequence correlationId, java.lang.CharSequence accountFromId, java.lang.CharSequence accountToId, java.lang.CharSequence amount) {
  ...
  /**
   * Creates a new ValidationStarted RecordBuilder.
   * @return A new ValidationStarted RecordBuilder
   */
  public static coordinator.schemas.validation.ValidationStarted.Builder newBuilder() {
    return new coordinator.schemas.validation.ValidationStarted.Builder();
  }

  /**
   * Creates a new ValidationStarted RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new ValidationStarted RecordBuilder
   */
  public static coordinator.schemas.validation.ValidationStarted.Builder newBuilder(coordinator.schemas.validation.ValidationStarted.Builder other) {
    return new coordinator.schemas.validation.ValidationStarted.Builder(other);
  }

  /**
   * Creates a new ValidationStarted RecordBuilder by copying an existing ValidationStarted instance.
   * @param other The existing instance to copy.
   * @return A new ValidationStarted RecordBuilder
   */
  public static coordinator.schemas.validation.ValidationStarted.Builder newBuilder(coordinator.schemas.validation.ValidationStarted other) {
    return new coordinator.schemas.validation.ValidationStarted.Builder(other);
  }

  /**
   * RecordBuilder for ValidationStarted instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ValidationStarted>
    implements org.apache.avro.data.RecordBuilder<ValidationStarted> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(coordinator.schemas.validation.ValidationStarted.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing ValidationStarted instance
     * @param other The existing instance to copy.
     */
    private Builder(coordinator.schemas.validation.ValidationStarted other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.transactionId)) {
        this.transactionId = data().deepCopy(fields()[0].schema(), other.transactionId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.validation.ValidationStarted.Builder setTransactionId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.validation.ValidationStarted.Builder clearTransactionId() {
      transactionId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.validation.ValidationStarted.Builder setCorrelationId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.validation.ValidationStarted.Builder clearCorrelationId() {
      correlationId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.validation.ValidationStarted.Builder setAccountFromId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.validation.ValidationStarted.Builder clearAccountFromId() {
      accountFromId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.validation.ValidationStarted.Builder setAccountToId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.validation.ValidationStarted.Builder clearAccountToId() {
      accountToId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.validation.ValidationStarted.Builder setAmount(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.validation.ValidationStarted.Builder clearAmount() {
      amount = null;
    ...
    public ValidationStarted build() {
      try {
        ValidationStarted record = new ValidationStarted();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<ValidationStarted>
    WRITER$ = (org.apache.avro.io.DatumWriter<ValidationStarted>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<ValidationStarted>
    READER$ = (org.apache.avro.io.DatumReader<ValidationStarted>)MODEL$.createDatumReader(SCHEMA$);
