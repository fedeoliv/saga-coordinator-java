...
public class ValidationSucceded extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7138470414017623103L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ValidationSucceded\",\"namespace\":\"coordinator.schemas.validation\",\"fields\":[{\"name\":\"transactionId\",\"type\":\"string\"},{\"name\":\"correlationId\",\"type\":\"string\"},{\"name\":\"accountFromId\",\"type\":\"string\"},{\"name\":\"accountToId\",\"type\":\"string\"},{\"name\":\"amount\",\"type\":\"string\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<ValidationSucceded> ENCODER =
      new BinaryMessageEncoder<ValidationSucceded>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<ValidationSucceded> DECODER =
      new BinaryMessageDecoder<ValidationSucceded>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageDecoder instance used by this class.
   */
  public static BinaryMessageDecoder<ValidationSucceded> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<ValidationSucceded> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<ValidationSucceded>(MODEL$, SCHEMA$, resolver);
  }

  /** Serializes this ValidationSucceded to a ByteBuffer. */
  public java.nio.ByteBuffer toByteBuffer() throws java.io.IOException {
    return ENCODER.encode(this);
  }

  /** Deserializes a ValidationSucceded from a ByteBuffer. */
  public static ValidationSucceded fromByteBuffer(
   ...
   */
  public ValidationSucceded(java.lang.CharSequence transactionId, java.lang.CharSequence correlationId, java.lang.CharSequence accountFromId, java.lang.CharSequence accountToId, java.lang.CharSequence amount) {
  ...
  /**
   * Creates a new ValidationSucceded RecordBuilder.
   * @return A new ValidationSucceded RecordBuilder
   */
  public static coordinator.schemas.validation.ValidationSucceded.Builder newBuilder() {
    return new coordinator.schemas.validation.ValidationSucceded.Builder();
  }

  /**
   * Creates a new ValidationSucceded RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new ValidationSucceded RecordBuilder
   */
  public static coordinator.schemas.validation.ValidationSucceded.Builder newBuilder(coordinator.schemas.validation.ValidationSucceded.Builder other) {
    return new coordinator.schemas.validation.ValidationSucceded.Builder(other);
  }

  /**
   * Creates a new ValidationSucceded RecordBuilder by copying an existing ValidationSucceded instance.
   * @param other The existing instance to copy.
   * @return A new ValidationSucceded RecordBuilder
   */
  public static coordinator.schemas.validation.ValidationSucceded.Builder newBuilder(coordinator.schemas.validation.ValidationSucceded other) {
    return new coordinator.schemas.validation.ValidationSucceded.Builder(other);
  }

  /**
   * RecordBuilder for ValidationSucceded instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ValidationSucceded>
    implements org.apache.avro.data.RecordBuilder<ValidationSucceded> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(coordinator.schemas.validation.ValidationSucceded.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing ValidationSucceded instance
     * @param other The existing instance to copy.
     */
    private Builder(coordinator.schemas.validation.ValidationSucceded other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.transactionId)) {
        this.transactionId = data().deepCopy(fields()[0].schema(), other.transactionId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.validation.ValidationSucceded.Builder setTransactionId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.validation.ValidationSucceded.Builder clearTransactionId() {
      transactionId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.validation.ValidationSucceded.Builder setCorrelationId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.validation.ValidationSucceded.Builder clearCorrelationId() {
      correlationId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.validation.ValidationSucceded.Builder setAccountFromId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.validation.ValidationSucceded.Builder clearAccountFromId() {
      accountFromId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.validation.ValidationSucceded.Builder setAccountToId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.validation.ValidationSucceded.Builder clearAccountToId() {
      accountToId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.validation.ValidationSucceded.Builder setAmount(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.validation.ValidationSucceded.Builder clearAmount() {
      amount = null;
    ...
    public ValidationSucceded build() {
      try {
        ValidationSucceded record = new ValidationSucceded();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<ValidationSucceded>
    WRITER$ = (org.apache.avro.io.DatumWriter<ValidationSucceded>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<ValidationSucceded>
    READER$ = (org.apache.avro.io.DatumReader<ValidationSucceded>)MODEL$.createDatumReader(SCHEMA$);
