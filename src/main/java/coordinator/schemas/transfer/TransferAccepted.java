 ...
 */
package coordinator.schemas.transfer;
...
public class TransferAccepted extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 9038054627769915417L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TransferAccepted\",\"namespace\":\"coordinator.schemas.transfer\",\"fields\":[{\"name\":\"transactionId\",\"type\":\"string\"},{\"name\":\"correlationId\",\"type\":\"string\"},{\"name\":\"accountFromId\",\"type\":\"string\"},{\"name\":\"accountToId\",\"type\":\"string\"},{\"name\":\"amount\",\"type\":\"string\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<TransferAccepted> ENCODER =
      new BinaryMessageEncoder<TransferAccepted>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<TransferAccepted> DECODER =
      new BinaryMessageDecoder<TransferAccepted>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageDecoder instance used by this class.
   */
  public static BinaryMessageDecoder<TransferAccepted> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<TransferAccepted> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<TransferAccepted>(MODEL$, SCHEMA$, resolver);
  }

  /** Serializes this TransferAccepted to a ByteBuffer. */
  public java.nio.ByteBuffer toByteBuffer() throws java.io.IOException {
    return ENCODER.encode(this);
  }

  /** Deserializes a TransferAccepted from a ByteBuffer. */
  public static TransferAccepted fromByteBuffer(
   ...
   */
  public TransferAccepted(java.lang.CharSequence transactionId, java.lang.CharSequence correlationId, java.lang.CharSequence accountFromId, java.lang.CharSequence accountToId, java.lang.CharSequence amount) {
  ...
  /**
   * Creates a new TransferAccepted RecordBuilder.
   * @return A new TransferAccepted RecordBuilder
   */
  public static coordinator.schemas.transfer.TransferAccepted.Builder newBuilder() {
    return new coordinator.schemas.transfer.TransferAccepted.Builder();
  }

  /**
   * Creates a new TransferAccepted RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new TransferAccepted RecordBuilder
   */
  public static coordinator.schemas.transfer.TransferAccepted.Builder newBuilder(coordinator.schemas.transfer.TransferAccepted.Builder other) {
    return new coordinator.schemas.transfer.TransferAccepted.Builder(other);
  }

  /**
   * Creates a new TransferAccepted RecordBuilder by copying an existing TransferAccepted instance.
   * @param other The existing instance to copy.
   * @return A new TransferAccepted RecordBuilder
   */
  public static coordinator.schemas.transfer.TransferAccepted.Builder newBuilder(coordinator.schemas.transfer.TransferAccepted other) {
    return new coordinator.schemas.transfer.TransferAccepted.Builder(other);
  }

  /**
   * RecordBuilder for TransferAccepted instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TransferAccepted>
    implements org.apache.avro.data.RecordBuilder<TransferAccepted> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(coordinator.schemas.transfer.TransferAccepted.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing TransferAccepted instance
     * @param other The existing instance to copy.
     */
    private Builder(coordinator.schemas.transfer.TransferAccepted other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.transactionId)) {
        this.transactionId = data().deepCopy(fields()[0].schema(), other.transactionId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.transfer.TransferAccepted.Builder setTransactionId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.transfer.TransferAccepted.Builder clearTransactionId() {
      transactionId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.transfer.TransferAccepted.Builder setCorrelationId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.transfer.TransferAccepted.Builder clearCorrelationId() {
      correlationId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.transfer.TransferAccepted.Builder setAccountFromId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.transfer.TransferAccepted.Builder clearAccountFromId() {
      accountFromId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.transfer.TransferAccepted.Builder setAccountToId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.transfer.TransferAccepted.Builder clearAccountToId() {
      accountToId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.transfer.TransferAccepted.Builder setAmount(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.transfer.TransferAccepted.Builder clearAmount() {
      amount = null;
    ...
    public TransferAccepted build() {
      try {
        TransferAccepted record = new TransferAccepted();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<TransferAccepted>
    WRITER$ = (org.apache.avro.io.DatumWriter<TransferAccepted>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<TransferAccepted>
    READER$ = (org.apache.avro.io.DatumReader<TransferAccepted>)MODEL$.createDatumReader(SCHEMA$);
