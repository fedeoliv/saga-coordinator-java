...
public class SignalingSucceded extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1669260281588850036L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"SignalingSucceded\",\"namespace\":\"coordinator.schemas.signaling\",\"fields\":[{\"name\":\"transactionId\",\"type\":\"string\"},{\"name\":\"correlationId\",\"type\":\"string\"},{\"name\":\"accountFromId\",\"type\":\"string\"},{\"name\":\"accountToId\",\"type\":\"string\"},{\"name\":\"amount\",\"type\":\"string\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<SignalingSucceded> ENCODER =
      new BinaryMessageEncoder<SignalingSucceded>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<SignalingSucceded> DECODER =
      new BinaryMessageDecoder<SignalingSucceded>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageDecoder instance used by this class.
   */
  public static BinaryMessageDecoder<SignalingSucceded> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SignalingSucceded> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<SignalingSucceded>(MODEL$, SCHEMA$, resolver);
  }

  /** Serializes this SignalingSucceded to a ByteBuffer. */
  public java.nio.ByteBuffer toByteBuffer() throws java.io.IOException {
    return ENCODER.encode(this);
  }

  /** Deserializes a SignalingSucceded from a ByteBuffer. */
  public static SignalingSucceded fromByteBuffer(
   ...
   */
  public SignalingSucceded(java.lang.CharSequence transactionId, java.lang.CharSequence correlationId, java.lang.CharSequence accountFromId, java.lang.CharSequence accountToId, java.lang.CharSequence amount) {
  ...
  /**
   * Creates a new SignalingSucceded RecordBuilder.
   * @return A new SignalingSucceded RecordBuilder
   */
  public static coordinator.schemas.signaling.SignalingSucceded.Builder newBuilder() {
    return new coordinator.schemas.signaling.SignalingSucceded.Builder();
  }

  /**
   * Creates a new SignalingSucceded RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new SignalingSucceded RecordBuilder
   */
  public static coordinator.schemas.signaling.SignalingSucceded.Builder newBuilder(coordinator.schemas.signaling.SignalingSucceded.Builder other) {
    return new coordinator.schemas.signaling.SignalingSucceded.Builder(other);
  }

  /**
   * Creates a new SignalingSucceded RecordBuilder by copying an existing SignalingSucceded instance.
   * @param other The existing instance to copy.
   * @return A new SignalingSucceded RecordBuilder
   */
  public static coordinator.schemas.signaling.SignalingSucceded.Builder newBuilder(coordinator.schemas.signaling.SignalingSucceded other) {
    return new coordinator.schemas.signaling.SignalingSucceded.Builder(other);
  }

  /**
   * RecordBuilder for SignalingSucceded instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SignalingSucceded>
    implements org.apache.avro.data.RecordBuilder<SignalingSucceded> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(coordinator.schemas.signaling.SignalingSucceded.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing SignalingSucceded instance
     * @param other The existing instance to copy.
     */
    private Builder(coordinator.schemas.signaling.SignalingSucceded other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.transactionId)) {
        this.transactionId = data().deepCopy(fields()[0].schema(), other.transactionId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.signaling.SignalingSucceded.Builder setTransactionId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.signaling.SignalingSucceded.Builder clearTransactionId() {
      transactionId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.signaling.SignalingSucceded.Builder setCorrelationId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.signaling.SignalingSucceded.Builder clearCorrelationId() {
      correlationId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.signaling.SignalingSucceded.Builder setAccountFromId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.signaling.SignalingSucceded.Builder clearAccountFromId() {
      accountFromId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.signaling.SignalingSucceded.Builder setAccountToId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.signaling.SignalingSucceded.Builder clearAccountToId() {
      accountToId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.signaling.SignalingSucceded.Builder setAmount(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.signaling.SignalingSucceded.Builder clearAmount() {
      amount = null;
    ...
    public SignalingSucceded build() {
      try {
        SignalingSucceded record = new SignalingSucceded();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<SignalingSucceded>
    WRITER$ = (org.apache.avro.io.DatumWriter<SignalingSucceded>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<SignalingSucceded>
    READER$ = (org.apache.avro.io.DatumReader<SignalingSucceded>)MODEL$.createDatumReader(SCHEMA$);
