...
public class ReceiptStarted extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -9186393827328562590L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ReceiptStarted\",\"namespace\":\"coordinator.schemas.receipt\",\"fields\":[{\"name\":\"transactionId\",\"type\":\"string\"},{\"name\":\"correlationId\",\"type\":\"string\"},{\"name\":\"accountFromId\",\"type\":\"string\"},{\"name\":\"accountToId\",\"type\":\"string\"},{\"name\":\"amount\",\"type\":\"string\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<ReceiptStarted> ENCODER =
      new BinaryMessageEncoder<ReceiptStarted>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<ReceiptStarted> DECODER =
      new BinaryMessageDecoder<ReceiptStarted>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageDecoder instance used by this class.
   */
  public static BinaryMessageDecoder<ReceiptStarted> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<ReceiptStarted> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<ReceiptStarted>(MODEL$, SCHEMA$, resolver);
  }

  /** Serializes this ReceiptStarted to a ByteBuffer. */
  public java.nio.ByteBuffer toByteBuffer() throws java.io.IOException {
    return ENCODER.encode(this);
  }

  /** Deserializes a ReceiptStarted from a ByteBuffer. */
  public static ReceiptStarted fromByteBuffer(
   ...
   */
  public ReceiptStarted(java.lang.CharSequence transactionId, java.lang.CharSequence correlationId, java.lang.CharSequence accountFromId, java.lang.CharSequence accountToId, java.lang.CharSequence amount) {
  ...
  /**
   * Creates a new ReceiptStarted RecordBuilder.
   * @return A new ReceiptStarted RecordBuilder
   */
  public static coordinator.schemas.receipt.ReceiptStarted.Builder newBuilder() {
    return new coordinator.schemas.receipt.ReceiptStarted.Builder();
  }

  /**
   * Creates a new ReceiptStarted RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new ReceiptStarted RecordBuilder
   */
  public static coordinator.schemas.receipt.ReceiptStarted.Builder newBuilder(coordinator.schemas.receipt.ReceiptStarted.Builder other) {
    return new coordinator.schemas.receipt.ReceiptStarted.Builder(other);
  }

  /**
   * Creates a new ReceiptStarted RecordBuilder by copying an existing ReceiptStarted instance.
   * @param other The existing instance to copy.
   * @return A new ReceiptStarted RecordBuilder
   */
  public static coordinator.schemas.receipt.ReceiptStarted.Builder newBuilder(coordinator.schemas.receipt.ReceiptStarted other) {
    return new coordinator.schemas.receipt.ReceiptStarted.Builder(other);
  }

  /**
   * RecordBuilder for ReceiptStarted instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ReceiptStarted>
    implements org.apache.avro.data.RecordBuilder<ReceiptStarted> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(coordinator.schemas.receipt.ReceiptStarted.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing ReceiptStarted instance
     * @param other The existing instance to copy.
     */
    private Builder(coordinator.schemas.receipt.ReceiptStarted other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.transactionId)) {
        this.transactionId = data().deepCopy(fields()[0].schema(), other.transactionId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.receipt.ReceiptStarted.Builder setTransactionId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.receipt.ReceiptStarted.Builder clearTransactionId() {
      transactionId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.receipt.ReceiptStarted.Builder setCorrelationId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.receipt.ReceiptStarted.Builder clearCorrelationId() {
      correlationId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.receipt.ReceiptStarted.Builder setAccountFromId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.receipt.ReceiptStarted.Builder clearAccountFromId() {
      accountFromId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.receipt.ReceiptStarted.Builder setAccountToId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.receipt.ReceiptStarted.Builder clearAccountToId() {
      accountToId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.receipt.ReceiptStarted.Builder setAmount(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.receipt.ReceiptStarted.Builder clearAmount() {
      amount = null;
    ...
    public ReceiptStarted build() {
      try {
        ReceiptStarted record = new ReceiptStarted();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<ReceiptStarted>
    WRITER$ = (org.apache.avro.io.DatumWriter<ReceiptStarted>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<ReceiptStarted>
    READER$ = (org.apache.avro.io.DatumReader<ReceiptStarted>)MODEL$.createDatumReader(SCHEMA$);
