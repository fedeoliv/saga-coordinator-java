...
public class ReceiptSucceded extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 326868934244740499L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ReceiptSucceded\",\"namespace\":\"coordinator.schemas.receipt\",\"fields\":[{\"name\":\"transactionId\",\"type\":\"string\"},{\"name\":\"correlationId\",\"type\":\"string\"},{\"name\":\"accountFromId\",\"type\":\"string\"},{\"name\":\"accountToId\",\"type\":\"string\"},{\"name\":\"amount\",\"type\":\"string\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<ReceiptSucceded> ENCODER =
      new BinaryMessageEncoder<ReceiptSucceded>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<ReceiptSucceded> DECODER =
      new BinaryMessageDecoder<ReceiptSucceded>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageDecoder instance used by this class.
   */
  public static BinaryMessageDecoder<ReceiptSucceded> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<ReceiptSucceded> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<ReceiptSucceded>(MODEL$, SCHEMA$, resolver);
  }

  /** Serializes this ReceiptSucceded to a ByteBuffer. */
  public java.nio.ByteBuffer toByteBuffer() throws java.io.IOException {
    return ENCODER.encode(this);
  }

  /** Deserializes a ReceiptSucceded from a ByteBuffer. */
  public static ReceiptSucceded fromByteBuffer(
   ...
   */
  public ReceiptSucceded(java.lang.CharSequence transactionId, java.lang.CharSequence correlationId, java.lang.CharSequence accountFromId, java.lang.CharSequence accountToId, java.lang.CharSequence amount) {
  ...
  /**
   * Creates a new ReceiptSucceded RecordBuilder.
   * @return A new ReceiptSucceded RecordBuilder
   */
  public static coordinator.schemas.receipt.ReceiptSucceded.Builder newBuilder() {
    return new coordinator.schemas.receipt.ReceiptSucceded.Builder();
  }

  /**
   * Creates a new ReceiptSucceded RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new ReceiptSucceded RecordBuilder
   */
  public static coordinator.schemas.receipt.ReceiptSucceded.Builder newBuilder(coordinator.schemas.receipt.ReceiptSucceded.Builder other) {
    return new coordinator.schemas.receipt.ReceiptSucceded.Builder(other);
  }

  /**
   * Creates a new ReceiptSucceded RecordBuilder by copying an existing ReceiptSucceded instance.
   * @param other The existing instance to copy.
   * @return A new ReceiptSucceded RecordBuilder
   */
  public static coordinator.schemas.receipt.ReceiptSucceded.Builder newBuilder(coordinator.schemas.receipt.ReceiptSucceded other) {
    return new coordinator.schemas.receipt.ReceiptSucceded.Builder(other);
  }

  /**
   * RecordBuilder for ReceiptSucceded instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ReceiptSucceded>
    implements org.apache.avro.data.RecordBuilder<ReceiptSucceded> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(coordinator.schemas.receipt.ReceiptSucceded.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing ReceiptSucceded instance
     * @param other The existing instance to copy.
     */
    private Builder(coordinator.schemas.receipt.ReceiptSucceded other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.transactionId)) {
        this.transactionId = data().deepCopy(fields()[0].schema(), other.transactionId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.receipt.ReceiptSucceded.Builder setTransactionId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.receipt.ReceiptSucceded.Builder clearTransactionId() {
      transactionId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.receipt.ReceiptSucceded.Builder setCorrelationId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.receipt.ReceiptSucceded.Builder clearCorrelationId() {
      correlationId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.receipt.ReceiptSucceded.Builder setAccountFromId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.receipt.ReceiptSucceded.Builder clearAccountFromId() {
      accountFromId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.receipt.ReceiptSucceded.Builder setAccountToId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.receipt.ReceiptSucceded.Builder clearAccountToId() {
      accountToId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.receipt.ReceiptSucceded.Builder setAmount(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public coordinator.schemas.receipt.ReceiptSucceded.Builder clearAmount() {
      amount = null;
    ...
    public ReceiptSucceded build() {
      try {
        ReceiptSucceded record = new ReceiptSucceded();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<ReceiptSucceded>
    WRITER$ = (org.apache.avro.io.DatumWriter<ReceiptSucceded>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<ReceiptSucceded>
    READER$ = (org.apache.avro.io.DatumReader<ReceiptSucceded>)MODEL$.createDatumReader(SCHEMA$);
